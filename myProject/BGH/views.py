...
def bgh_result(request):
    ...
    # user input
    sales = round(float(request.GET['sales']), 2)
    ln_sales = round(float(request.GET['ln_sales']), 2)
    print('LNH: ', cal_lnh(ln_sales))
    print("BGH: ", cal_bgh(sales, ln_sales))

    return render(request, 'bgh_result.html', {'lnh': cal_lnh(ln_sales), 'bgh': cal_bgh(sales, ln_sales)})
